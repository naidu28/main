...
public class BlackjackHandDemo extends JApplet {
    ...
    public void init()
    {
    	...
    	JButton1.setBounds(500,358,212,32);
    	...
    	scoreLbl.setFont(new Font("Dialog", Font.BOLD, 20));
    	scoreLbl.setBounds(500,250,212,88);
    	//computer score
    	scoreLblC.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
    	scoreLblC.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
    	getContentPane().add(scoreLblC);
    	scoreLblC.setForeground(java.awt.Color.black);
    	scoreLblC.setFont(new Font("Dialog", Font.BOLD, 20));
    	scoreLblC.setBounds(500,48,212,88);
    	//human score
    	scoreLblH.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
    	scoreLblH.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
    	getContentPane().add(scoreLblH);
    	scoreLblH.setForeground(java.awt.Color.black);
    	scoreLblH.setFont(new Font("Dialog", Font.BOLD, 20));
    	scoreLblH.setBounds(500,550,212,88);
    	//}}
    	...
    	do {
    	    ...
    	    if (myHand.evaluateHand() == compHand.evaluateHand()) { // will return 0 if equal
    	        tie = true;
    	    } else tie = false;
    ...
    javax.swing.JLabel scoreLblH = new javax.swing.JLabel();
    javax.swing.JLabel scoreLblC = new javax.swing.JLabel();
    //}}
    
    
    private void showBlackjackScore() {
        int hScore = myHand.evaluateHand();
        int cScore = compHand.evaluateHand();
        if (hScore < cScore) {
            scoreLbl.setText("Computer win!");
            scoreLbl.setForeground( Color.red );
            cVal++;
            scoreLblC.setText("Comp: " +cVal);
        } else if (hScore > cScore) {
            scoreLbl.setText("Human win!");
            scoreLbl.setForeground( Color.blue );
            hVal++;
            scoreLblH.setText("Human: " + hVal);
        } else {
            scoreLbl.setText("Tie!");
